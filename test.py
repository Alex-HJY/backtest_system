...
bs.back_test_by_day(trade_func=trade_funcs2.trade_func2, strategy_name='美林时钟_3_1', start_date='20120101',
                    end_date='20180101')

bs = backtest_system.backtest_system(price_data=pricedata, benchmark_code='HS300收盘价')
bs.back_test_by_day(trade_func=trade_funcs2.trade_func2, strategy_name='美林时钟_3_1_var_主观', start_date='20120101',
                    end_date='20180101')
